...
function check() {
  ...
  if (greenStates.includes(inputtedState)) {
    resultElement.textContent = `${inputtedState} is an ACCEPTED ZIP.`;
    resultElement.className = "mt-6 text-xl font-bold text-green-600 dark:text-green-400";
  } else {
    resultElement.textContent = `${inputtedState} is NOT an ACCEPTED ZIP.`;
    resultElement.className = "mt-6 text-xl font-bold text-red-600 dark:text-red-400";
  }
